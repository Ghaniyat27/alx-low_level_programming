Makefiles
Project done during Full Stack Software Engineering studies at ALX SE. It aim is to learn what are makefiles, when, why and how to use them (with variables, explicit and implicit rules.
Files
